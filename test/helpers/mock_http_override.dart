...
class MockHttpClient extends Mock implements HttpClient {
  ...
  Future<HttpClientRequest> getUrl(Uri? url) {
    ...
    return super.noSuchMethod(Invocation.method(#getUrl, [url]), returnValue: Future.value(MockHttpClientRequest()));
  }
}
...
class MockHttpClientRequest extends Mock implements HttpClientRequest {
  @override
  // ignore: invalid_use_of_visible_for_testing_member
  HttpHeaders get headers => super.noSuchMethod(Invocation.getter(#headers), returnValue: MockHttpHeaders());

  @override
  Future<HttpClientResponse> close() =>
      // ignore: invalid_use_of_visible_for_testing_member
      super.noSuchMethod(Invocation.method(#close, []), returnValue: Future.value(MockHttpClientResponse()));
}
...
MockHttpClient createMockImageHttpClient() {
  ...
  when(client.getUrl(any)).thenAnswer((Invocation invocation) {
    return Future<HttpClientRequest>.value(
      invocation.positionalArguments[0].path.endsWith(".svg") ? svgRequest : request,
    );
  });
...
void mockRequestResponse({
  ...
  when(response.listen(
    ...
    return Stream<List<int>>.fromIterable(<List<int>>[image])
