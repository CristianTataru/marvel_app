...
import './step/i_scroll_to_text.dart';
...
void main() {
  group('''CreatorsPage''', () {
    testWidgets('''Open CreatorsPage and load paginated data successfully''', (tester) async {
      ...
      await iWait(tester);
      await iScrollToBottomOfPage(tester, 'creatorsPageScrollKey');
      await iWait(tester);
      await iScrollToBottomOfPage(tester, 'creatorsPageScrollKey');
      await iSeeText(tester, 'Balcells');
    });
  });
}
